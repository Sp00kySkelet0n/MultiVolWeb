# Very VERY VERY HACKY way of running shell commands... I had to implement this weird code because when running
# in docker without a full TTY the json files generated by the CLI are empty... I don't have time to fix it right now.
